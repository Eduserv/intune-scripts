<#PSScriptInfo
.VERSION 1.0.0
.GUID f1a6c64d-27d4-4199-a773-c94b9ae2a18a
.AUTHOR Nick Brown
...
<#
.SYNOPSIS
  Creates and uploads an app from Winget
.DESCRIPTION
...
.Adapted from the original script from https://github.com/andrew-s-taylor/public
.INPUTS
